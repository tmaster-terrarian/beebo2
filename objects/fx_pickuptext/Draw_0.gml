...
draw_sprite_outlined_ext((_spr != -1) ? _spr : spr_item_missing, 0, x - 82, y + 62, 1, 1, 0, c_white, (_spr != -1) ? global.itemdata.rarity_colors[getdef(item_id, deftype.item).rarity] : global.itemdata.rarity_colors[0], image_alpha, image_alpha, 0)
