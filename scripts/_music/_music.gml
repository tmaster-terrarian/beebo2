function set_music(ind, loop = 1, crossfade = 0)
{
    ...
    addQueueFunc(function() {if(global.__oldBGM != -1) audio_stop_sound(global.__oldBGM); global.__olfBGM = -1}, crossfade + 1/60)
}
...
function stop_music(fade = 0)
{
    ...
    addQueueFunc(function() {audio_stop_sound(global.BGM); global.BGM = -1}, fade + 1/60)
}
